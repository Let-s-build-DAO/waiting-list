...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        foreach ($contacts as $contact) {
            ...
            $message = generateEmailContent($name, $email, $phoneNumber, $message, $services);
...
function generateEmailContent($name, $email, $phoneNumber, $message, $services) {
    $message = "
        <html>
        <head>
...
function generateSenderEmailContent($name, $services) {
    $bodySender = "
        <html>
        <head>
          ...
          <div style='display: flex; justify-content: center; padding-top:8%; padding-bottom:10%'>
              <div style='width: 100%; padding: 8%;'>
                  <div>
                      ...
                      <p style='font-size: 16px; font-family: scandia-web, sans-serif; font-weight: 400; color: #1e1f21; margin-top: 32px;'>
                        We see that you are interested in <b>$services</b>.
                        <br /><br />
